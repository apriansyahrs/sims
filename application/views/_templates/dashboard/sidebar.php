    ...
    <div class="sidebar">
        ...
        <nav class="mt-2 mb-5">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                $master = ["datatahun", "dataguru", "datajurusan", "datakelas", "datamapel", "dataekstra", "datasiswa", "datadokumen"];
                ...
                <li class="nav-item has-treeview <?= in_array($page, $master) ? "menu-open" : "" ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('datatahun') ?>" class="nav-link <?= $page === 'datatahun' ? "active" : "" ?>">
                ...
                <li class="nav-item has-treeview <?= in_array($page, $elearning) ? "menu-open" : "" ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('kelasjadwal') ?>" class="nav-link <?= $page === 'kelasjadwal' ? "active" : "" ?>">
                ...
                <li class="nav-item has-treeview <?= in_array($page, $cbt) ? "menu-open" : "" ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('cbtjenis') ?>" class="nav-link <?= $page === 'cbtjenis' ? "active" : "" ?>">
                                <i class="fa fa-project-diagram nav-icon"></i>
                                <p>Jenis Ujian</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('cbtsesi') ?>" class="nav-link <?= $page === 'cbtsesi' ? "active" : "" ?>">
                                <i class="far fa-clock nav-icon"></i>
                                <p>Sesi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('cbtruang') ?>" class="nav-link <?= $page === 'cbtruang' ? "active" : "" ?>">
                                <i class="fa fa-door-open nav-icon"></i>
                                <p>Ruang</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('cbtsesisiswa') ?>" class="nav-link <?= $page === 'cbtsesisiswa' ? "active" : "" ?>">
                                <i class="fa fa-user-clock nav-icon"></i>
                                <p>Atur Ruang dan Sesi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('cbtnomorpeserta') ?>" class="nav-link <?= $page === 'cbtnomorpeserta' ? "active" : "" ?>">
                                <i class="far fa-id-card nav-icon"></i>
                                <p>Atur Nomor Peserta</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('cbtbanksoal') ?>" class="nav-link <?= $page === 'cbtbanksoal' ? "active" : "" ?>">
                                <i class="far fa-folder-open nav-icon"></i>
                                <p>Bank Soal</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('cbtjadwal') ?>" class="nav-link <?= $page === 'cbtjadwal' ? "active" : "" ?>">
                ...
                <li class="nav-item has-treeview <?= in_array($page, $infoelearning) ? "menu-open" : "" ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('kelasnilai') ?>" class="nav-link <?= $page === 'kelasnilai' ? "active" : "" ?>">
                ...
                <li class="nav-item has-treeview <?= in_array($page, $infoujian) ? "menu-open" : "" ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('cbtcetak') ?>" class="nav-link <?= $page === 'cbtcetak' ? "active" : "" ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('cbtnilai') ?>" class="nav-link <?= $page === 'cbtnilai' ? "active" : "" ?>">
                ...
                <li class="nav-item has-treeview <?= in_array($page, $usermanager) ? "menu-open" : "" ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('useradmin') ?>" class="nav-link <?= $page === 'useradmin' ? "active" : "" ?>">
                                <i class="fas fa-cog nav-icon"></i>
                                <p>Administrator</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('userguru') ?>" class="nav-link <?= $page === 'userguru' ? "active" : "" ?>">
