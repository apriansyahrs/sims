        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <?php if ($this->ion_auth->is_admin()) : ?>
                    <div class="col-6">
                        <a href="<?= base_url('userorangtua') ?>" type="button" class="btn btn-sm btn-danger float-right">
                ...
                <div class="col-md-9">
                    <div class="card card-warning my-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <?= form_open('userorangtua/update', array('id' => 'editsiswa'), array('method' => 'edit', 'id_siswa' => $siswa->id_siswa)) ?>
