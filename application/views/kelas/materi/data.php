                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-default" data-toggle="tooltip" title="Export As Excel" onclick="exportExcel()">
                                <i class="fa fa-file-excel"></i> <span class="d-none d-sm-inline-block ml-1"> Excel</span>
                            </button>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        if (count($curr_materi) > 0) : ?>
                            <div class="col-12 table-responsive" id="preview">
                                <table class="w-100 table table-bordered">
                                    <tr class="alert alert-success">
                                        ...
                                        <th rowspan="2" class="text-center align-middle hidden">Status</th>
                                        <th rowspan="2" class="text-center align-middle hidden" style="width: 100px">Aksi</th>
                                    </tr>
                                    <tr class="alert alert-success">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                            <td rowspan="<?= $rows ?>" class="text-center align-middle hidden">
                                                <button
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-0">
                ...
                <div id="empty" class="d-none">
                    <p>Jadwal Pelajaran belum diatur</p>
                </div>
...
<script>
    ...
    function exportExcel() {
        // Clone the table element from the preview
        var clonedTable = cloneTable(); // Get the cloned table
        var tempDiv = document.createElement('div');
        tempDiv.appendChild(clonedTable[0]); // Insert the cloned table into a temporary div

        // Create a data URL with the Excel content
        var tableHTML = tempDiv.innerHTML.replace(/ /g, '%20');

        // Define the name of the file
        var filename = `${docTitle}.xls`;
