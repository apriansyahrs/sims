...
/*   ________________________________________
    ...
    |________________________________________|
*/
class Cbtanalisis extends MY_Controller
{
    ...
    public function getNilaiKelas()
    {
        ...
        foreach ($siswas as $siswa) {
            ...
            $arrDur[$siswa->id_siswa] = [
                'dur' => $this->cbt->getDurasiSiswa($siswa->id_siswa .'0'. $jadwal),
    ...
    private function nilaiSignifikansi($jml){
        ...
        if (isset($list[$jml])) {
            if (isset($list[$jml]['5'])) return $list[$jml]['5'];
            else return $list[$jml]['1'];
        } else {
            $keys = $this->getClosest($jml, array_keys($list));
            if ($keys < 4) $keys = 4;
            if (isset($list[$keys]['5'])) return $list[$keys]['5'];
            else return $list[$keys]['1'];
        }
    }
